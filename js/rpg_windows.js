...
Window_Status.prototype.drawBlock1 = function(y) {
    ...
    this.drawActorFace(this._actor, 0, 0, 144, 100);//(X軸Y軸、幅　高)
    this.drawBasicInfo(150, y);
    this.drawExpInfo(150, y+GYOU*2);
...
Window_Status.prototype.drawExpInfo = function(x, y) {
    ...
    this.contents.fillRect(x+130,80, 480, 6, this.gaugeBackColor());//ゲージ描画
    this.contents.gradientFillRect(x+130,80, value2 / value3 * 480, 6,this.textColor(27), this.textColor(0));
    }
    ...
    this.drawText('/', x+482, y , 270);
    this.resetTextColor();
    this.drawText(value1, x+190, y, 200, 'left');
    this.drawText(value2, x+280, y, 200, 'right');
    this.drawText(value3, x+500, y, 200, 'left');
};
...
Window_Status.prototype.drawParameters = function(x, y) {
        ...
        this.contents.gradientFillRect(x+45,y+GYOU*0+2,this._actor.param(0)/250, 30,this.textColor(14), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*1+2,this._actor.param(1)/7.5, 30,this.textColor(9), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*2+2,this._actor.param(2)/2.5, 30,this.textColor(24), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*3+2,this._actor.param(3)/2.5, 30,this.textColor(24), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*4+2,this._actor.param(4)/2.5, 30,this.textColor(24), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*5+2,this._actor.param(5)/2.5, 30,this.textColor(24), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*6+2,this._actor.param(6)/2.5, 30,this.textColor(24), this.textColor(0));
        this.contents.gradientFillRect(x+45,y+GYOU*7+2,this._actor.param(7)/2.5, 30,this.textColor(24), this.textColor(0));

       this.changeTextColor(this.systemColor());
        this.drawText(TextManager.param(0), x, y+GYOU*0, 160);
        this.drawText(TextManager.param(1), x, y+GYOU*1, 160);
        this.drawText(TextManager.param(2), x, y+GYOU*2, 160);
        this.drawText(TextManager.param(3), x, y+GYOU*3, 160);
        this.drawText(TextManager.param(4), x, y+GYOU*4, 160);
        this.drawText(TextManager.param(5), x, y+GYOU*5, 160);
        this.drawText(TextManager.param(6), x, y+GYOU*6, 160);
        this.drawText(TextManager.param(7), x, y+GYOU*7, 160);
       this.resetTextColor();
        this.drawText(this._actor.param(0), x + 45, y+GYOU*0, 60, 'left');
        this.drawText(this._actor.param(1), x + 45, y+GYOU*1, 60, 'left');
        this.drawText(this._actor.param(2), x + 45, y+GYOU*2, 60, 'left');
        this.drawText(this._actor.param(3), x + 45, y+GYOU*3, 60, 'left');
        this.drawText(this._actor.param(4), x + 45, y+GYOU*4, 60, 'left');
        this.drawText(this._actor.param(5), x + 45, y+GYOU*5, 60, 'left');
        this.drawText(this._actor.param(6), x + 45, y+GYOU*6, 60, 'left');
        this.drawText(this._actor.param(7), x + 45, y+GYOU*7, 60, 'left');


//ここから2行目
//上から拳脚剣弓杖音虹　7つアイコン
        this.drawIcon(1, x+250,y+GYOU*0);
        this.drawIcon(2, x+250,y+GYOU*1);
        this.drawIcon(3, x+250,y+GYOU*2);
        this.drawIcon(4, x+250,y+GYOU*3);
        this.drawIcon(5, x+250,y+GYOU*4);
        this.drawIcon(19, x+250,y+GYOU*5);
        this.drawIcon(20, x+250,y+GYOU*6);


//上から拳脚剣弓杖音　7つ実数値
        this.drawText(Math.floor(this._actor.elementRate(1)*100), x+275 , y+GYOU*0, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(2)*100), x+275 , y+GYOU*1, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(3)*100), x+275 , y+GYOU*2, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(4)*100), x+275 , y+GYOU*3, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(5)*100), x+275 , y+GYOU*4, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(19)*100), x+275 , y+GYOU*5, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(20)*100), x+275 , y+GYOU*6, 60, 'right');
...
//「％」を６個並べる
       this.changeTextColor(this.systemColor());
        ...
        this.drawText('％', x+335, y+GYOU*6, 160);
       this.resetTextColor();
...
//ここから3行目
//上から炎水雷風氷花光闇　8つアイコン
        this.drawIcon(11, x+370,y+GYOU*0);
        this.drawIcon(12, x+370,y+GYOU*1);
        this.drawIcon(13, x+370,y+GYOU*2);
        this.drawIcon(14, x+370,y+GYOU*3);
        this.drawIcon(15, x+370,y+GYOU*4);
        this.drawIcon(16, x+370,y+GYOU*5);
        this.drawIcon(17, x+370,y+GYOU*6);
        this.drawIcon(18, x+370,y+GYOU*7);


//上から拳脚剣弓杖音　8つ実数値
        this.drawText(Math.floor(this._actor.elementRate(11)*100), x+395 , y+GYOU*0, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(12)*100), x+395 , y+GYOU*1, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(13)*100), x+395 , y+GYOU*2, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(14)*100), x+395 , y+GYOU*3, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(15)*100), x+395 , y+GYOU*4, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(16)*100), x+395 , y+GYOU*5, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(17)*100), x+395 , y+GYOU*6, 60, 'right');
        this.drawText(Math.floor(this._actor.elementRate(18)*100), x+395 , y+GYOU*7, 60, 'right');

//「％」を６個並べる
       this.changeTextColor(this.systemColor());
        this.drawText('％', x+455, y+GYOU*0, 160);
        this.drawText('％', x+455, y+GYOU*1, 160);
        this.drawText('％', x+455, y+GYOU*2, 160);
        this.drawText('％', x+455, y+GYOU*3, 160);
        this.drawText('％', x+455, y+GYOU*4, 160);
        this.drawText('％', x+455, y+GYOU*5, 160);
        this.drawText('％', x+455, y+GYOU*6, 160);
        this.drawText('％', x+455, y+GYOU*7, 160);
...
//上から命中率～会心率、HPMPST再生
 this.changeTextColor(this.systemColor());
        this.drawText(TextManager.param(8), x+490, y+GYOU*0, 160);
        this.drawText(TextManager.param(9), x+490, y+GYOU*1, 160); 
        this.drawText('CRI', x+490, y+GYOU*2, 160); 
        this.drawText('HP+', x+490, y+GYOU*3, 160);
        this.drawText('MP+', x+490, y+GYOU*4, 160);
        this.drawText('ST+', x+490, y+GYOU*5, 160);
//命中とかの実数値
       this.resetTextColor();
        this.drawText(Math.floor(this._actor.xparam(0)*100), x+515 , y+GYOU*0, 60, 'right');
        this.drawText(Math.floor(this._actor.xparam(1)*100), x+515 , y+GYOU*1, 60, 'right');
        this.drawText(Math.floor(this._actor.xparam(2)*100), x+515 , y+GYOU*2, 60, 'right');
        this.drawText(Math.floor(this._actor.xparam(7)*100), x+515 , y+GYOU*3, 60, 'right');
        this.drawText(Math.floor(this._actor.xparam(8)*100), x+515 , y+GYOU*4, 60, 'right'); 
        this.drawText(Math.floor(this._actor.xparam(9)*100), x+515 , y+GYOU*5, 60, 'right');
//「％」を６個並べる
       this.changeTextColor(this.systemColor());
        this.drawText('％', x+575, y+GYOU*0, 160);
        this.drawText('％', x+575, y+GYOU*1, 160);
        this.drawText('％', x+575, y+GYOU*2, 160);
        this.drawText('％', x+575, y+GYOU*3, 160);
        this.drawText('％', x+575, y+GYOU*4, 160);
        this.drawText('％', x+575, y+GYOU*5, 160);
...
//ここから5行目
//アクセ一覧
        this.drawItemName(equips[11], x+610, y+GYOU*0);
        this.drawItemName(equips[12], x+610, y+GYOU*1);
        this.drawItemName(equips[13], x+610, y+GYOU*2);
        this.drawItemName(equips[14], x+610, y+GYOU*3);
        this.drawItemName(equips[15], x+610, y+GYOU*4);
        this.drawItemName(equips[16], x+610, y+GYOU*5);
        this.drawItemName(equips[17], x+610, y+GYOU*6);
        this.drawItemName(equips[18], x+610, y+GYOU*7);
...
Window_Status.prototype.drawEquipments = function(x, y) {
    ...
    var GYOU = this.lineHeight();
        ...
        this.drawItemName(equips[4], x+576, y+GYOU*0);
        this.drawItemName(equips[5], x, y+GYOU*1);
        this.drawItemName(equips[6], x+576, y+GYOU*1);
        this.drawItemName(equips[7], x, y+GYOU*2);
        this.drawItemName(equips[8], x+576, y+GYOU*2);
        this.drawItemName(equips[9], x, y+GYOU*3);
        this.drawItemName(equips[10], x+576, y+GYOU*3);
};
...
//-----------------------------------------------------------------------------
// Window_ShopNumber
//購入するを選んで下に出る枠のうち右のステータスとかのるウィンドウ
//アイテム名の幅はここではYEP ITEM COREで変更する
...
Window_ShopNumber.prototype.windowWidth = function() {
    return 756;//商品のステータスウィンドウの始まる位置
};
...
Window_BattleStatus.prototype.drawBasicArea = function(rect, actor) {
    this.drawActorName(actor, rect.x + 0, rect.y, 151);
    this.drawActorIcons(actor, rect.x + 156, rect.y, 600);//アイコンエリア
};
...
Window_BattleStatus.prototype.drawGaugeAreaWithTp = function(rect, actor) {
   this.drawActorHp(actor, rect.x + 200, rect.y, 95);
   this.drawActorMp(actor, rect.x + 300, rect.y, 95);
   this.drawActorTp(actor, rect.x + 400, rect.y, 95);
...
Window_TitleCommand.prototype.updatePlacement = function() {
    this.x = 846//(Graphics.boxWidth - this.width) / 2;
